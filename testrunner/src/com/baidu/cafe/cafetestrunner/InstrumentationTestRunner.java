...
package com.baidu.cafe.cafetestrunner;
...
public class InstrumentationTestRunner extends Instrumentation implements TestSuiteProvider {
    ...
    // Default file name for timer code coverage
    private static final String DEFAULT_TIMER_COVERAGE_FILE_NAME = "coverage_timer.ec";
    ...
    //used to dump coverage data periodly, add by linrongwen@baidu.com    
    private Timer timer = new Timer();
    private int mInternalMsec;
    ...
    public void onCreate(Bundle arguments) {
	    ...
	    try {
                Object internal = arguments.get("internal");  // Accept either string or int
                if (internal != null) mInternalMsec = Integer.parseInt(internal.toString());
            } catch (NumberFormatException e) {
                Log.e(LOG_TAG, "Invalid internal_msec parameter", e);
            }
        }
    ...
    */
    ...
    public void onStart() {
        ...
        if (mJustCount) {
            ...
            try {
                ...
                if(mCoverage && mInternalMsec > 0) {
		    Log.i(LOG_TAG, "timer.scheduleAtFixedRate of " + mInternalMsec + " seconds");
                    timer.scheduleAtFixedRate(new CoverageDataDumper(), mInternalMsec*1000, mInternalMsec*1000);			   }
    ...
    private class CoverageDataDumper extends TimerTask {

        @Override
        public void run() {
            // TODO Auto-generated method stub
            Log.i(LOG_TAG, "CoverageDataDumper start generate coverage report...");
            String coverageFilePath = getTargetContext().getFilesDir().getAbsolutePath() + File.separator +
                   DEFAULT_TIMER_COVERAGE_FILE_NAME;
            generateCoverageReport(coverageFilePath);
        }
